...
1. Run the existing local KIS portfolio sync every minute and refresh authenticated holdings in the browser every minute. Verify: no Synology collector or realtime Worker endpoint remains.
