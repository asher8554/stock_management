...
assert.deepEqual(rows, [{ provider: "토스증권", name: "삼성전자", symbol: "005930", quantity: "3", marketValue: "210000", lastPrice: undefined, averagePurchasePrice: undefined, gainRate: null, currency: "KRW" }]);

const kisRows = portfolioRows({ accounts: [{ provider: "kis", items: [{ name: "KODEX 코스피100", symbol: "237350", quantity: "5", marketValue: "438975", currency: "KRW", lastPrice: "1000", averagePurchasePrice: "800" }] }] });
