...
const cache = new Map();
const env = { INGEST_TOKEN: "ingest", ALLOWED_EMAIL: "asher8554@gmail.com", PORTFOLIO_CACHE: { get: (key) => cache.get(key), put: (key, value) => cache.set(key, value) } };
...
const privateResponse = await worker.fetch(new Request("https://api/v1/portfolio"), env, { access: { identity: { email: "asher8554@gmail.com" } } });
