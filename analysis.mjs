...
function renderChart(host, item, ticks, intraday, unit, range) {
  ...
  requestAnimationFrame(() => { host.scrollLeft = Math.max(0, host.scrollWidth - host.clientWidth - scrollRight); });
}
