...
function renderChart(host, item, ticks, intraday, unit, range) {
  ...
  legend.innerHTML = `<span class="ma20">20${maUnit}선</span><span class="ma60">60${maUnit}선</span><span class="ma120">120${maUnit}선</span>`; axis.innerHTML = priceAxis.map(({ value, top }) => `<span style="top:${top - 9}px">${Math.round(value).toLocaleString("ko-KR")}</span>`).join("");
